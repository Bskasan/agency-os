...
<template>
	<BlockContainer class="relative grid gap-6 sm:gap-8 md:gap-12 md:grid-cols-3">
		<!-- Content -->
		...
		>
			<NuxtImg
				v-if="data.image"
				class="w-full overflow-hidden dark:brightness-90 max-h-[700px] h-auto object-cover rounded-card"
